...
<head>
  ...
  <title>Tracksuits Collection</title>
...
<body>
  ...
  <main class="product-container">
    <h2>Tracksuits Collection</h2>
    <section id="tracksuits-list">
  ...
  <script src="<?php echo $baseUrl; ?>/frontend/assets/js/tracksuits.js"></script>
